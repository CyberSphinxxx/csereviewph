...
const NEWPASS_FIELDS: FieldSpec[] = [
...
export function AuthStandaloneForm({ initialState = "signin" }: { initialState?: AuthStandaloneState }) {
  ...
  const activeFields = useMemo<FieldSpec[]>(() => {
    switch (state) {
      case "signin": return SIGNIN_FIELDS;
      case "create": return CREATE_FIELDS;
      case "reset": return RESET_FIELDS;
      case "newpass": return NEWPASS_FIELDS;
      default: return [];
    }
  }, [state]);
