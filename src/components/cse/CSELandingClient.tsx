  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground relative selection:bg-[#f8edef] selection:text-[#86152d]">
      ...
      <main className="flex-1 animate-page-enter">
        ...
        {/* ========================================================================= */}
        <section className="relative overflow-hidden lg:min-h-[calc(100vh-8.5rem)] flex flex-col justify-center pt-8 pb-14 sm:pt-12 sm:pb-16 lg:pt-14 lg:pb-20 xl:pb-28 border-b border-border bg-gradient-to-b from-white via-brand-50/20 to-background dark:from-[#1E191C] dark:via-[#1E191C]/60 dark:to-background">
